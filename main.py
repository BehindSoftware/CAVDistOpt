...
def get_options():
    ...
    optParser.add_option(
        ...
        type="int",
        default=100,
        help="End time for randomTrips.py (-e parameter)"
    )
    ...
    optParser.add_option(
        ...
        type="int",
        default=5,
        help="Number of raw intersections (x direction)"
    )
    ...
    optParser.add_option(
        ...
        type="int",
        default=5,
        help="Number of column intersections (y direction)"
    )
...
if __name__ == "__main__":
    ...
    for param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12 in itertools.product(t, max_speed, lower_acc, upper_acc, speed_loc_fac, reaction_t, safety_distance, vehicle_length, MAX_ITER, TIME_GAP, TOLERANCE, RHO):
        ...
        parameters = set_parameters(param1, param2, param3, param4, param5, param6, param7, param8, 500, options.raw_int, options.col_int, 2, 0, param9, param10, param11, param12)
        ...
        if(MAPCREATION_ACTIVE==True):
            ...
            if(ROUTECREATION_ACTIVE==True):
                os.system("python3 /usr/share/sumo/tools/randomTrips.py -n data/cross.nettest.xml -e {options.trip_end} --route-file data/cross.routest.xml --validate ")
